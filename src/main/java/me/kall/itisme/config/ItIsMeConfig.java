...
public class ItIsMeConfig {
    ...
    public static final ModConfigSpec.BooleanValue PLAYER_OUTLINE_RENDERABLE, BOSS_OUTLINE_RENDERABLE, NEUTRAL_OUTLINE_RENDERABLE, HOSTILE_OUTLINE_RENDERABLE, ENTITY_OUTLINE_RENDERABLE;
    ...
    public static final ModConfigSpec.IntValue NEUTRAL_OUTLINE_RED, NEUTRAL_OUTLINE_GREEN, NEUTRAL_OUTLINE_BLUE, NEUTRAL_OUTLINE_ALPHA;
    public static final ModConfigSpec.IntValue HOSTILE_OUTLINE_RED, HOSTILE_OUTLINE_GREEN, HOSTILE_OUTLINE_BLUE, HOSTILE_OUTLINE_ALPHA;
    ...
    public static final ModConfigSpec.BooleanValue CHANGE_ATTACKABLE_OUTLINE_COLOR;
    public static final ModConfigSpec.IntValue ATTACKABLE_OUTLINE_RED, ATTACKABLE_OUTLINE_GREEN, ATTACKABLE_OUTLINE_BLUE, ATTACKABLE_OUTLINE_ALPHA;

    public static final ModConfigSpec.ConfigValue<List<? extends String>> CUSTOM_ENTITY_OUTLINE_COLOR;

    public static final ModConfigSpec.BooleanValue PLAYER_SHADOW_OUTLINE_RENDERABLE, BOSS_SHADOW_OUTLINE_RENDERABLE, NEUTRAL_SHADOW_OUTLINE_RENDERABLE, HOSTILE_SHADOW_OUTLINE_RENDERABLE, ENTITY_SHADOW_OUTLINE_RENDERABLE;

    public static final ModConfigSpec.DoubleValue PLAYER_SHADOW_RADIUS_EXT, BOSS_SHADOW_RADIUS_EXT, NEUTRAL_SHADOW_RADIUS_EXT, HOSTILE_SHADOW_RADIUS_EXT, ENTITY_SHADOW_RADIUS_EXT;
    ...
    public static final ModConfigSpec.IntValue NEUTRAL_SHADOW_OUTLINE_RED, NEUTRAL_SHADOW_OUTLINE_GREEN, NEUTRAL_SHADOW_OUTLINE_BLUE, NEUTRAL_SHADOW_OUTLINE_ALPHA;
    public static final ModConfigSpec.IntValue HOSTILE_SHADOW_OUTLINE_RED, HOSTILE_SHADOW_OUTLINE_GREEN, HOSTILE_SHADOW_OUTLINE_BLUE, HOSTILE_SHADOW_OUTLINE_ALPHA;
    ...
    public static final ModConfigSpec.BooleanValue CHANGE_ATTACKABLE_SHADOW_OUTLINE_COLOR;
    public static final ModConfigSpec.IntValue ATTACKABLE_SHADOW_OUTLINE_RED, ATTACKABLE_SHADOW_OUTLINE_GREEN, ATTACKABLE_SHADOW_OUTLINE_BLUE, ATTACKABLE_SHADOW_OUTLINE_ALPHA;

    public static final ModConfigSpec.ConfigValue<List<? extends String>> CUSTOM_ENTITY_SHADOW_OUTLINE_COLOR;
    public static final ModConfigSpec.ConfigValue<List<? extends String>> CUSTOM_SHADOW_RADIUS_EXT;
